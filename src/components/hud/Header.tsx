...
export default function Header() {
    ...
    const handleBackToMenu = () => {
        if (window.confirm(t('game.quit_confirm', { defaultValue: 'Return to main menu? Your game will be saved.' }))) {
            useUIStore.getState().setScreen('splash');
        }
    };
    ...
    return (
        <div className="flex items-center justify-between px-3 md:px-6 lg:px-8 py-2 md:py-3 safe-top">
            ...
            <div className="flex items-center gap-2">
                ...
                >
                    <span className="text-[10px] font-bold uppercase" style={{ color: '#DAA520' }}>{t('game.month')}</span>
                ...
                <div className="flex items-center gap-1.5">
                    ...
                    <span className="font-display text-xs md:text-sm text-white font-semibold truncate max-w-30">
